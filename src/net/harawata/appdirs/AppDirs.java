...
public abstract class AppDirs {
    public String getUserDataDir(String appName, String appVersion) {
        return getUserDataDir(appName, appVersion, false);
    }

    public abstract String getUserDataDir(String appName, String appVersion, boolean roaming);

    public String getUserConfigDir(String appName, String appVersion) {
        return getUserConfigDir(appName, appVersion,false);
    }

    public abstract String getUserConfigDir(String appName, String appVersion, boolean roaming);
    ...
    public String getSiteDataDir(String appName, String appVersion) {
        return getSiteDataDir(appName, appVersion, false);
    }

    public abstract String getSiteDataDir(String appName, String appVersion, boolean multiPath);

    public String getSiteConfigDir(String appName, String appVersion) {
        return getSiteConfigDir(appName, appVersion, false);
    }

    public abstract String getSiteConfigDir(String appName, String appVersion, boolean multiPath);
